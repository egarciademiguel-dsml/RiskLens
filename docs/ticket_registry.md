...
| RL-046 | EVT diagnostic suite | Done | src/analytics/evt.py, tests/test_evt.py | Six diagnostic functions: mean_residual_life, gpd_stability, gpd_qq, gpd_ks_test, gpd_bootstrap_ci, decluster_pot. Validates GPD fit, justifies threshold, quantifies parameter uncertainty, addresses iid violation. 44/44 EVT tests pass (22 existing + 22 new) |
