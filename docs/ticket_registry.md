...
| RL-040 | Surface Student-t df<3 as stability warning | Pending | src/analytics/vol_garch.py, app/streamlit_app.py | Reframed under RL-042: do NOT cap df; surface df<3 as "danger zone" indicator (finite-variance assumption violated). Capping hides information |
